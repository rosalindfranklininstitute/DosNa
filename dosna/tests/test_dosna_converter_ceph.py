...
# TODO: add to test_dosna_converter.
class Hdf5todosnaTest(unittest.TestCase):
    ...
    def setUp(self):
        if not self.dn_connection.connected:
            self.dn_connection = dn.Connection("dosna", conffile="ceph.conf")
            self.dn_connection.connect()
            self.dn_converter = Dosnatohdf5(self.dn_connection)
    ...
    def compare_datasets_hdf(self, dn_dset, hdf_dset):
        self.assertEqual(dn_dset.name, hdf_dset.name)
    ...
    def test_dosna2dict(self):
        ...
        self.assertDictEqual(dn_cluster['/A'].get_attrs(), dosna_dict['/A']['attrs'])
        self.assertEqual(dn_cluster['/A']['/A/B'].get_attrs(), dosna_dict['/A']['/A/B']['attrs'])
        self.assertEqual(dn_cluster['/A']['/A/B']['/A/B/D'].get_attrs(), dosna_dict['/A']['/A/B']['/A/B/D']['attrs'])
        self.assertEqual(dn_cluster['/A']['/A/C'].get_attrs(), dosna_dict['/A']['/A/C']['attrs'])

        # self.check_keys(dn_cluster['/A'].keys(), dosna_dict['/A'])
        # self.check_keys(dn_cluster['/A']['/A/B'].keys(), dosna_dict['/A']['/A/B'])
        # self.check_keys(dn_cluster['/A']['/A/B']['/A/B/D'].keys(), dosna_dict['/A']['/A/B']['/A/B/D'])
        # self.check_keys(dn_cluster['/A']['/A/C'].keys(), dosna_dict['/A']['/A/C'])

        dn_cluster_dset1 = dn_cluster['/A']['/A/B']['/A/B/dset1']
        dosna_dict_dset1 = dosna_dict['/A']['/A/B']["datasets"]['/A/B/dset1']
        self.compare_datasets_dosna(dn_cluster_dset1, dosna_dict_dset1)

        dn_cluster_dset2 = dn_cluster['/A']['/A/B']['/A/B/dset2']
        dosna_dict_dset2 = dosna_dict['/A']['/A/B']["datasets"]['/A/B/dset2']
    ...
    def test_dosna2hdf(self):
        ...
        # self.assertEqual(set(hdf_file['/A']['/A/B'].keys()), set(dn_cluster['/A']['/A/B'].keys()))
        # self.assertEqual(set(hdf_file['/A']['/A/B']['/A/B/D'].keys()), set(dn_cluster['/A']['/A/B']['/A/B/D'].keys()))
        # self.assertEqual(set(hdf_file['/A']['/A/C'].keys()), set(dn_cluster['/A']['/A/C'].keys()))

        hdf_file_dset1 = hdf_file['/A']['/A/B']['dset1']
        dn_cluster_dset1 = dn_cluster['/A']['/A/B']['/A/B/dset1']
        self.compare_datasets_hdf(dn_cluster_dset1, hdf_file_dset1)

        hdf_file_dset2 = hdf_file['/A']['/A/B']['dset2']
        dn_cluster_dset2 = dn_cluster['/A']['/A/B']['/A/B/dset2']
    ...
    def test_dosna2json(self):
        ...
        self.assertDictEqual(dn_cluster['/A'].get_attrs(), json_dict['/A']['attrs'])
        self.assertEqual(dn_cluster['/A']['/A/B'].get_attrs(), json_dict['/A']['/A/B']['attrs'])
        self.assertEqual(dn_cluster['/A']['/A/B']['/A/B/D'].get_attrs(), json_dict['/A']['/A/B']['/A/B/D']['attrs'])
        self.assertEqual(dn_cluster['/A']['/A/C'].get_attrs(), json_dict['/A']['/A/C']['attrs'])

        # self.check_keys(dn_cluster['/A'].keys(), json_dict['/A'])
        # self.check_keys(dn_cluster['/A']['/A/B'].keys(), json_dict['/A']['/A/B'])
        # self.check_keys(dn_cluster['/A']['/A/B']['/A/B/D'].keys(), json_dict['/A']['/A/B']['/A/B/D'])
        # self.check_keys(dn_cluster['/A']['/A/C'].keys(), json_dict['/A']['/A/C'])

        dn_cluster_dset1 = dn_cluster['/A']['/A/B']['/A/B/dset1']
        json_dict_dset1 = json_dict['/A']['/A/B']['datasets']['/A/B/dset1']
        self.compare_datasets_json(dn_cluster_dset1, json_dict_dset1)

        dn_cluster_dset2 = dn_cluster['/A']['/A/B']['/A/B/dset2']
        json_dict_dset2 = json_dict['/A']['/A/B']['datasets']['/A/B/dset2']
